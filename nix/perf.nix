...
let
  ...
  #
  # (`powerpcle` used to need a special case here, because its kernel came out
  # big-endian whatever its name said. The target is retired instead -- see
  # configs/6.13/powerpcle.unused -- so the identity mapping is now honest for
