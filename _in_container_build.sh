...
for TARGET in $TARGETS; do
    ...
    if [[ "$VERSION" == "4.10" && "$TARGET" == powerpc* ]]; then
        ...
        extra_wnoerr="-Wno-error -Wno-error=stringop-truncation -Wno-error=format-truncation -Wno-error=maybe-uninitialized -Wno-error=deprecated-declarations -Wno-error=array-bounds -Wno-error=missing-attributes"
